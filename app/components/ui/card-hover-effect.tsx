...
export const CardTitle = ({
  ...
  return (
    <h4
      className={cn(
        'text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-blue-500 font-bold tracking-wide mt-4 text-2xl',
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        'mt-4 text-slate-300 tracking-wide leading-relaxed',
        className
      )}
    >
      {children}
